...
export class CcButton extends LitElement {
  ...
  constructor () {
    ...
    /** @type {Number} If set, enables delay mechanism and defined the number of seconds before the `cc-button:click` event is actually fired */
    this.delay = null;
    ...
    /** @type {String} If set, enables icon mode and sets the `src` of the inner native `<img>` element */
    this.image = null;
