...
export class CcEnvVarForm extends LitElement {
  ...
  constructor () {
    ...
    /** @type {"env-var"|"env-var-simple"|"env-var-addon"|"exposed-config"} Defines where the form will be used so it can display the appropriate heading and description */
    this.context = null;

    /** @type {"saving"|"loading"} Displays an error message (saving or loading) */
    this.error = null;

    /** @type {String} Sets a text to be used as a header title */
    this.heading = null;
