...
export const translations = {
  ...
  'cc-grafana-info.addon-description': () => sanitize`Ce tableau de bord comprend plusieurs tuiles présentant les métriques des modules complémentaires des applications Clever Cloud. <br> Il fournit d'abord un panneau de présentation contenant les données du serveur telles que <strong> le cpu, la mémoire, les disques et le réseau</strong>. Un second panneau présente la base de données, et contient des données uniquement pour les modules <strong> MySQL, PostgreSQL, MongoDB et redis</strong>. Ce panneau fournira des informations comme <strong> le nombre de connexions, de requêtes ou de transactions, d'erreurs ou de blocages ou encore d'opérations "tuples"<strong>.`,
  'cc-grafana-info.addon-title': `Aperçu du tableau de bord des modules complémentaires d'applications`,
  'cc-grafana-info.disable-description': `Désactiver grafana supprimera et mettra fin aux accès à l'organisation du Grafana.`,
  'cc-grafana-info.disable-title': `Désactiver Grafana`,
  'cc-grafana-info.documentation-description': `Ce module complémentaire est utilisé pour visualiser les métriques des applications Clever Cloud. Vous pouvez trouver la documentation et les détails de ce service ici.`,
  'cc-grafana-info.documentation-title': `Documentation`,
  'cc-grafana-info.enable-description': `L'activation de grafana créera et fournira les accès à une organisation Grafana pour afficher les métriques des runtimes et des modules complémentaires des applications de l'organisation Clever Cloud. Si vous êtes déjà connecté à Grafana, vous devrez vous déconnecter/vous reconnecter pour voir cette organisation dans Grafana.`,
  ...
  'cc-grafana-info.error-link-doc': `Une erreur s'est produite lors du chargement du lien de documentation du Grafana.`,
