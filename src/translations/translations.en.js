...
export const translations = {
  ...
  'cc-grafana-info.disable-description': `Disabling grafana will delete and end all accesses to this Grafana organisation.`,
  'cc-grafana-info.disable-title': `Disable Grafana`,
  'cc-grafana-info.documentation-description': `This add-on is used to visualize Clever Cloud Metrics data. You can find the documentation and details about this service here.`,
  'cc-grafana-info.documentation-title': `Documentation`,
  'cc-grafana-info.enable-description': `Enabling grafana will create and provide all accesses to a Grafana organisation to view this Clever Cloud organisation's applications runtimes and add-on metrics. If you are already loged in Grafana, you will need to logout/relogin to view this organisation.`,
  ...
  'cc-grafana-info.organization-description': () => sanitize`This dashboard includes several graphs about a Clever Cloud organisation. <br> It provides a graph summarising the amount of <strong>deployed applications runtimes and add-ons</strong>. It also provides a count per <strong> application type</strong> or <strong>runtime flavor</strong>. The <strong>deployment state</strong> graph indicates the state of all deployments performed during the elapsed Grafana time interval. And finally on this dashboard you will retrieve <strong>global and specific links</strong> (sorted by requests count) to access an application runtime or add-on dashboard.`,
  'cc-grafana-info.organization-title': `Organisation dashboard preview`,
  'cc-grafana-info.reset-description': `Reset all clever cloud dashboards to their initial state.`,
  'cc-grafana-info.reset-title': `Resets all dashboards`,
  'cc-grafana-info.runtime-description': () => sanitize`This dashboard features an <strong>overview panel</strong> to get quick information about an application, as well as several panels about Clever Cloud application runtime metrics. <br> It provides graph summarizing the state of <strong>the memory, disks, cpu and load usages or the network usages</strong>. For each of these metric types, you will retrieve usage graphs, gauges, as well as the result of a simple linear prediction done on the elapsed Grafana time interval. This linear prediction yields the expected duration for the metric to reach 90%.`,
